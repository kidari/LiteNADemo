...
public class Constant {
    ...
    public static final String APPID = "A_93xVRJbrZRrl5fjqP5W6CTxnMa";
    public static final String SECRET = "93ez4sYjkmfqPl3SkAPXpZ_fCo0a";
    //millenario
//    public static final String APPID = "i68JulxnGNrsZiJkgPg5wfrvSJMa";
//    public static final String SECRET = "t6_ylil6j6ubkgxDBXQjAtRi160a";
    /*
     ...
     */
    public static final String CALLBACK_BASE_URL = "https://114.116.6.0:8099";
...
//    public static final String FW_UPGRADE_CALLBACK_URL = CALLBACK_BASE_URL + "/na/iocm/devNotify/v1.1.0/upgradeFW";
    public static final String DEVICE_ADDED_CALLBACK_URL = CALLBACK_BASE_URL + "/v1.0.0/messageReceiver";
    public static final String DEVICE_INFO_CHANGED_CALLBACK_URL = CALLBACK_BASE_URL + "/v1.0.0/messageReceiver";
    public static final String DEVICE_DATA_CHANGED_CALLBACK_URL = CALLBACK_BASE_URL + "/v1.0.0/messageReceiver";
    public static final String DEVICE_DELETED_CALLBACK_URL = CALLBACK_BASE_URL + "/v1.0.0/messageReceiver";
    public static final String MESSAGE_CONFIRM_CALLBACK_URL = CALLBACK_BASE_URL + "/v1.0.0/messageReceiver";
    public static final String SERVICE_INFO_CHANGED_CALLBACK_URL = CALLBACK_BASE_URL + "/v1.0.0/messageReceiver";
    public static final String COMMAND_RSP_CALLBACK_URL = CALLBACK_BASE_URL + "/v1.0.0/messageReceiver";
    public static final String DEVICE_EVENT_CALLBACK_URL = CALLBACK_BASE_URL + "/v1.0.0/messageReceiver";
    public static final String RULE_EVENT_CALLBACK_URL = CALLBACK_BASE_URL + "/v1.0.0/messageReceiver";
    public static final String DEVICE_DATAS_CHANGED_CALLBACK_URL = CALLBACK_BASE_URL + "/v1.0.0/messageReceiver";
    public static final String DEVICE_SHADOW_MODIFIED_CALLBACK_URL = CALLBACK_BASE_URL + "/v1.0.0/messageReceiver";
    
    public static final String SW_UPGRADE_CALLBACK_URL = CALLBACK_BASE_URL + "/v1.0.0/messageReceiver";
    public static final String FW_UPGRADE_CALLBACK_URL = CALLBACK_BASE_URL + "/v1.0.0/messageReceiver";
...
//    public static final String REPORT_CMD_EXEC_RESULT_CALLBACK_URL = CALLBACK_BASE_URL + "/na/iocm/devNotify/v1.1.0/reportCmdExecResult";
    ...
    public static final String REPORT_CMD_EXEC_RESULT_CALLBACK_URL = CALLBACK_BASE_URL + "/v1.0.0/messageReceiver";
